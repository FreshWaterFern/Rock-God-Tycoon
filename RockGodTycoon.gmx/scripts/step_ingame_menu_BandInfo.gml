...
if ( mouse_check_area(1596-20,213-60,1596+20,213+60) ){mouse_over = 2;}if ( button_select == 2 ){
spr[2]=global.sprite_map[?"Band_Info\Band Info Tab\Band Info Button Effect.png"]}else{spr[2]=global.sprite_map[?"Band_Info\Band Info Tab\Band Info Button.png"]}

if ( mouse_check_area(1596-20,370-60,1596+20,370+60) ){mouse_over = 3;}if ( button_select == 3 ){
spr[3]=global.sprite_map[?"Band_Info\Songs and Records Tab\Song and record Button Effect.png"]}else{spr[3]=global.sprite_map[?"Band_Info\Songs and Records Tab\Song and record Button.png"]}
...
case 0:{band_info_page_left=1;surface_update=true;break;}
case 1:{band_info_page_left=0;surface_update=true;break;}
case 2:{band_info_page_right=1;surface_update=true;break;}
case 3:{band_info_page_right=0;surface_update=true;break;}
