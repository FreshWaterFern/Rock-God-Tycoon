/// fps_draw_sprite(sprite_index,image_index,x,y,z,xscale,yscale,angle,blend,alpha)
...
draw_sprite_ext(argument0,argument1,fps_xx,zz-(fps_yy*fps_get_ver(zz)),argument5*scale,argument6*scale,argument7,argument8,argument9)
