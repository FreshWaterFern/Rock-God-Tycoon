...
if ( ds_list_size(global.item_list_eyes) > 8 ){
...
var i = 0;var r = 0;var size = ds_list_size(global.item_list_eyes);var size2 = 0;
...
equiplist_inst[|size2].Item_Name = global.item_list_eyes[|size2];
equiplist_inst[|size2].Item_Price = global.price_list_eyes[|size2];
}
}
...
if ( mouse_check_button_pressed(mb_left) ){
if ( !Locked ){
scr_equip_item(obj_character_pose1,"Eyes",Item_Name);}}}}
}
