...
draw_background(obj_game.img_ext[4],0,27);
...
// Head Button
scr_button_handle("Character Creation\Tattoos Sub Menu\Buttons\Tattoo_Head_button.png","Character Creation\Tattoos Sub Menu\Buttons\Tattoo_Head_button_effect.png",0,344,199,210,70);
// Torso Button
scr_button_handle("Character Creation\Tattoos Sub Menu\Buttons\Tattoo_Torso_button.png","Character Creation\Tattoos Sub Menu\Buttons\Tattoo_Torso_button_effect.png",1,374,352,230,70);
// Arm Button
scr_button_handle("Character Creation\Tattoos Sub Menu\Buttons\Tattoo_Arm_button.png","Character Creation\Tattoos Sub Menu\Buttons\Tattoo_Arm_button_effect.png",2,360,515,210,70);
// Hands Button
scr_button_handle("Character Creation\Tattoos Sub Menu\Buttons\Tattoo_Hands_button.png","Character Creation\Tattoos Sub Menu\Buttons\Tattoo_Hands_button_effect.png",3,364,664,220,70);
// Legs Button
scr_button_handle("Character Creation\Tattoos Sub Menu\Buttons\Tattoo_Legs_button.png","Character Creation\Tattoos Sub Menu\Buttons\Tattoo_Legs_button_effect.png",4,364,811,220,70);
