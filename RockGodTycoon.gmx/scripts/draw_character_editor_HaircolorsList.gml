/// draw_character_editor_HaircolorsList()
...
if ( ds_list_size(global.item_list_haircolors) > 8 ){
...
var i = 0;var r = 0;var size = ds_list_size(global.item_list_haircolors);var size2 = 0;
...
equiplist_inst[|size2].Item_Name = global.item_list_haircolors[|size2];
equiplist_inst[|size2].Item_Price = global.price_list_haircolors[|size2];
}
}
