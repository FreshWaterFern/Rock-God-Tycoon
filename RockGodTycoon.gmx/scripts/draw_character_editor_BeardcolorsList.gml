/// draw_character_editor_BeardcolorsList()
...
if ( ds_list_size(global.item_list_beardcolors) > 8 ){
...
var i = 0;var r = 0;var size = ds_list_size(global.item_list_beardcolors);var size2 = 0;
...
equiplist_inst[|size2].Item_Name = global.item_list_beardcolors[|size2];
equiplist_inst[|size2].Item_Price = global.price_list_beardcolors[|size2];
}
}
...
if ( mouse_check_button_pressed(mb_left) ){
if ( !Locked ){
scr_equip_item(obj_character_pose1,"COLOR",Item_Name);}}}}
}
